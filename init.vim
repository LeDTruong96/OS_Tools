source $HOME/.config/nvim/plug_config/setting.vim
source $HOME/.config/nvim/plug_config/plugin.vim
source $HOME/.config/nvim/plug_config/key-bindings.vim
source $HOME/.config/nvim/plug_config/vim-which-key.vim
source $HOME/.config/nvim/plug_config/themes.vim
source $HOME/.config/nvim/plug_config/flutter.vim
source $HOME/.config/nvim/plug_config/nvim-compe.vim
source $HOME/.config/nvim/plug_config/hop.vim
source $HOME/.config/nvim/plug_config/TmuxNav.vim
